...
| --- | --- | --- | ---: | ---: |
| B3_itemwise_theta | none | b3_itemwise_theta | 0.520 | 0.042 |
| B3_itemwise_theta | theta_label_and_total | b3_itemwise_theta_residual | 0.503 | 0.082 |
| predicted_total | none | predicted_total_norm | 0.528 | 0.039 |
| predicted_total | theta_label_and_total | predicted_total_norm_residual | 0.445 | 0.045 |
| psychometric_predicted_theta | none | theta_pred | 0.543 | 0.048 |
| psychometric_predicted_theta | theta_label_and_total | theta_pred_residual | 0.467 | 0.088 |

## Output Fidelity

| output | metric | mean | std |
| --- | --- | ---: | ---: |
| B3_itemwise_theta | Observed Macro Item MAE | 0.693 | 0.008 |
| B3_itemwise_theta | Observed Total MAE | 4.209 | 0.040 |
| B3_itemwise_theta | Theta MAE | 0.688 | 0.016 |
| predicted_total | Normalized Total MAE | 0.176 | 0.002 |
| predicted_total | Raw Total MAE | 4.228 | 0.045 |
| psychometric_predicted_theta | Observed Macro Item MAE | 0.687 | 0.008 |
| psychometric_predicted_theta | Observed Total MAE | 4.283 | 0.052 |
| psychometric_predicted_theta | Theta MAE | 0.687 | 0.014 |
