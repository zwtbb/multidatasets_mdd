...
Generated: `2026-08-09T09:06:57+00:00`
...
- Pooled E-DAIC delta vs train mean: `-0.028`.
- Pooled CMDC delta vs train mean: `-0.178`.
- Pooled E-DAIC delta vs total allocation: `-0.003`.
- Pooled CMDC delta vs total allocation: `0.003`.
- PDCH HAMD-proxy delta vs train mean: `-0.017`.
- Feature identity BA: `1.000`.
- Prediction identity BA: `0.980`.
...
| --- | --- | --- | --- | ---: | ---: | ---: |
| pdch_hamd_internal_cv | hamd_proxy | pdch | bge_itemwise_ridge | 0.655 | -0.017 | -0.008 |
| pdch_hamd_internal_cv | hamd_proxy | pdch | total_alloc_ridge | 0.663 | -0.009 | 0.000 |
| pdch_hamd_internal_cv | hamd_proxy | pdch | train_mean | 0.672 | 0.000 | 0.009 |
| pooled_shared_phq | phq_core | cmdc | bge_itemwise_ridge | 0.679 | -0.178 | 0.003 |
| pooled_shared_phq | phq_core | cmdc | total_alloc_ridge | 0.676 | -0.181 | 0.000 |
| pooled_shared_phq | phq_core | cmdc | train_mean | 0.857 | 0.000 | 0.181 |
| pooled_shared_phq | phq_core | edaic | bge_itemwise_ridge | 0.704 | -0.028 | -0.003 |
| pooled_shared_phq | phq_core | edaic | total_alloc_ridge | 0.708 | -0.025 | 0.000 |
| pooled_shared_phq | phq_core | edaic | train_mean | 0.732 | 0.000 | 0.025 |
...
| prediction_identity_pooled_phq_edaic_cmdc | Balanced Accuracy | 0.980 | 0.030 |
