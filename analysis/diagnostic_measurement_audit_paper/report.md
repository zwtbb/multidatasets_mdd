...
Generated: `2026-08-11T13:01:11+00:00`
...
| --- | --- |
| Full gate reads 26 Phase 5 summaries; status blocked_but_publishable_diagnostic_direction; full_method_allowed=False. | Full method construction remains blocked; diagnostic paper framing is allowed with bounded claims. |
| MV08 improves over total-score floor on 0/3 pooled active slices with prediction identity BA 0.900. MV08b improves over both floors on 2/3 slices, but prediction identity BA 0.979 exceeds gate 0.900. | Partial-invariance and residual measurement are diagnostic negative evidence under current features. |
