...
def build_claim_gate(summaries: dict[str, dict[str, Any]]) -> pd.DataFrame:
    ...
    rows = [
        ...
        },
        {
            ...
            "required_next_evidence": "Run MV12 X-to-theta prediction without subject-level theta scores or fitted-parameter release.",
            "primary_sources": "P5_MV10;P5_MV11;P5_MV12_design",
        },
        {
...
def build_next_actions(summaries: dict[str, dict[str, Any]]) -> pd.DataFrame:
    ...
    if mv12_design.get("readiness_status") == "ready_to_implement_mv12_two_stage_latent_target":
