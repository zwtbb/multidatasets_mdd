...
def build_next_actions(summaries: dict[str, dict[str, Any]]) -> pd.DataFrame:
    ...
    if mv14_design.get("design_status") == "ready_to_implement_mv14_measurement_uncertainty_bootstrap":
