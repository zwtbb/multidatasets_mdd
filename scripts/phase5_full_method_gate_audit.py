...
def build_claim_gate(summaries: dict[str, dict[str, Any]]) -> pd.DataFrame:
    ...
    rows = [
        ...
        },
        {
            ...
            "required_next_evidence": "Run the predeclared MV16 DIF-guided calibration if moving beyond label-measurement evidence toward target-measurement adaptation claims.",
            "primary_sources": "P5_MV10;P5_MV11;P5_MV12_design;P5_MV12;P5_MV12_analysis;P5_MV13_design;P5_MV13;P5_MV14_design;P5_MV14;P5_MV16_design",
        },
        {
...
def build_next_actions(summaries: dict[str, dict[str, Any]]) -> pd.DataFrame:
    ...
    if mv16_design.get("design_status") == "ready_to_implement_mv16_dif_guided_calibration":
