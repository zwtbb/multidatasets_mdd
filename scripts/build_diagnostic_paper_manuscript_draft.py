...
def build_open_items(bib_status: dict[str, Any]) -> pd.DataFrame:
    ...
    rows = [
        ...
        },
        {
            ...
            "priority": "high",
            "area": "psychometrics",
            "open_item": "Resolve the MV13/MV14 mirt parameterization blocker by correcting and rerunning the anchor-linked focal mean/variance specification, or explicitly limit manuscript wording to the current fixed-hyperparameter qualitative screen.",
            "blocking_for_submission": True,
        },
    ]
    return pd.DataFrame(rows)
